...
public class CancelTicket implements TicketTabelView{
    private Stage stage;
    private Scene scene;
    private int index;
    ...
    @Override
     public void draw(){
        ...
        deleteButton.setOnAction((ActionEvent event) -> {
            Ticket selectedItem = (Ticket) table.getSelectionModel().getSelectedItem();
            index=table.getSelectionModel().getSelectedIndex();
            tripsFile.writeInTicketFile(userName+".txt",index);
